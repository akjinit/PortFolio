...
const projects = [
  {
    ...
    description:
      "Production-grade ride booking app with live driver discovery, OTP verification, and map-based UX.",
    image: "/projects/project1.png",
    tags: ["React", "Node.js", "MongoDB", "WebSockets", "Leaflet"],
  ...
  },
  {
    ...
    description:
      "A lightweight note & snippet manager with instant CRUD, persistent local storage, and keyboard-first UX.",
  ...
  },
  {
    ...
    description:
      "A responsive recipe discovery platform powered by public food APIs with dynamic search and client-side caching.",
